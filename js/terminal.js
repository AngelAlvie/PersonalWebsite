...
const maybe = function(contract, default_item) {
...
function Terminal(properties) {
  ...
  /** Initialize terminal. returns a promise to initialize a terminal object
   * 
   */
    ...
    return new Promise((resolve, reject) => {
      ...
      if (loadingStrings) {
        loadingStrings.forEach(function(string, index, array) {
          //we can do this because JS supports closures.
          out(string, function() {
